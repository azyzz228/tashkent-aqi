defmodule TashkentAqNotifierWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TashkentAqNotifierWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TashkentAqNotifierWeb.Gettext, "errors", msg, opts)
    end
  end
