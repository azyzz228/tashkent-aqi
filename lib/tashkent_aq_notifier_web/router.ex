defmodule TashkentAqNotifierWeb.Router do
  use TashkentAqNotifierWeb, :router

  import TashkentAqNotifierWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {TashkentAqNotifierWeb.Layouts, :root}
  ...
  if Application.compile_env(:tashkent_aq_notifier, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TashkentAqNotifierWeb.Telemetry
  ...
  scope "/", TashkentAqNotifierWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TashkentAqNotifierWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TashkentAqNotifierWeb do
    ...
    live_session :current_user,
      on_mount: [{TashkentAqNotifierWeb.UserAuth, :mount_current_user}] do
