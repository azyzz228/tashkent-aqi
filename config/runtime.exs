...
#
#     PHX_SERVER=true bin/tashkent_aq_notifier start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :tashkent_aq_notifier, TashkentAqNotifierWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :tashkent_aq_notifier, TashkentAqNotifier.Mailer,
